...
const Privacy = () => {
  return (
    <div className="flex privacy-page flex-col flex-1 justify-center gap-10 p-10 text-left">

<div className="header">
    <div className="container">
    <p className="title font-bold text-3xl">Privacy Policy for Analyst Next Door</p>
    </div>
    </div>
    ...
    <li>
    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Analyst Next Door.</p>
    </li>
    <li>
    ...
    <li>
    <p><strong>Website</strong> refers to Analyst Next Door, accessible from <a href="https://analystnextdoor.com" rel="external nofollow noopener" target="_blank">https://analystnextdoor.com</a></p>
    </li>
    <li>
    ...
    <ul>
    <li>
    <p>By email: support@analystnextdoor.com</p>
    </li>
    </ul>
    </div>
    </div>
